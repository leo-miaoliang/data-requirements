...
from
    ...
    and date(convert_tz(from_unixtime(create_at), '+00:00', '+08:00')) <= '2018-11-26'
...
join
    (select
        date1
    from bi.dim_date
    where date1 between '2018-12-31' and '2019-01-27'
    )   t3
;
...
from
    ...
    from
        (select
            ...
            ,max(id) as max_id
        from newuuabc.student_hours_record
        where date(convert_tz(from_unixtime(create_at), '+00:00', '+08:00')) <= '2018-12-31'
    ...
    from
        (select
            ...
            ,max(id) as max_id
        from newuuabc.student_hours_record
        where date(convert_tz(from_unixtime(create_at), '+00:00', '+08:00')) <= '2019-01-27'
        and subject_id in (1, 7)
        group by student_user_id, subject_id
        )   t1
    inner join
...
drop table if exists tmp_teacher_student_1231;
create temporary table tmp_teacher_student_1231 as
select
    t3.teacher_id
    ,t3.teacher_name
    ,t3.student_id
    ,t3.student_name
    ,t3.date1
    ,case when t8.student_id is not null and t8.date1 <= '2018-12-31' then coalesce(t7.after_hours_1v1, 0) else 0 end as cnt_1v1
    ,case when t8.student_id is not null and t8.date1 <= '2018-12-31' then coalesce(t7.after_hours_1v4, 0) else 0 end as cnt_1v4
from
    (select
        t1.student_id
        ,t1.student_name
    ...
    from
        ...
        where partition_key = date_format('2018-12-31', '%Y%m%d')
        and flag = 1
        and disable = 0
        )   t1
    inner join
...
-- select
--  *
-- from tmp_teacher_student_0127
-- ;


drop table if exists tmp_teacher_student_0127;
create temporary table tmp_teacher_student_0127 as
select
    t3.teacher_id
    ,t3.teacher_name
    ,t3.student_id
    ,t3.student_name
    ,t3.date1
    ,case when t8.student_id is not null and t8.date1 <= '2019-01-27' then coalesce(t7.after_hours_1v1, 0) else 0 end as cnt_1v1
    ,case when t8.student_id is not null and t8.date1 <= '2019-01-27' then coalesce(t7.after_hours_1v4, 0) else 0 end as cnt_1v4
from
    (select
        t1.student_id
        ,t1.student_name
    ...
    from
        (select
            ...
            ,'2019-01-27' as date1
        from bi.student_user_his
        where partition_key = date_format('2019-01-27', '%Y%m%d')
        and flag = 1
        and disable = 0
        )   t1
    inner join
...
left join
    (select
        teacher_id
        ,teacher_name
        ,sum(case when date1 = '2018-12-31' and cnt_1v1 > 0 then 1 else 0 end) as cnt1v1  -- 20181126带1v1学员数
        ,sum(case when date1 = '2018-12-31' and cnt_1v4 > 0 then 1 else 0 end) as cnt1v4  -- 20181230带1v1学员数
    from tmp_teacher_student_1231
...
left join
    (select
        teacher_id
        ,teacher_name
        ,sum(case when date1 = '2019-01-27' and cnt_1v1 > 0 then 1 else 0 end) as cnt1v1  -- 20181126带1v4学员数
        ,sum(case when date1 = '2019-01-27' and cnt_1v4 > 0 then 1 else 0 end) as cnt1v4  -- 20181230带1v4学员数
    from tmp_teacher_student_0127
    group by teacher_id, teacher_name
    )   t2
on  t1.teacher_id = t2.teacher_id
...
from
    ...
    from bi.student_user_his
    where partition_key between date_format('2018-12-31', '%Y%m%d') and date_format('2019-01-27', '%Y%m%d')
    and flag = 1
    and disable = 0
...
--          ,case when t1.cnt_1v4 > 0 then coalesce(t3.cnt_1v4, 0) else 0 end as cnt_1v4
        ...
        left join
            ...
            from
                ...
                and disabled = 0
                and course_type = 3
                and date(convert_tz(from_unixtime(start_time), '+00:00', '+08:00')) between '2018-12-31' and '2019-01-27'
                ...
                where status = 3
                and class_type = 1
                and date(from_unixtime(start_time)) between '2018-12-31' and '2019-01-27'
        ...
        left join
            ...
            from newuuabc.contract
    --      where date(convert_tz(from_unixtime(sucess_at), '+00:00', '+08:00')) between '2018-12-31' and '2019-01-27'
...
from
    ...
    from
        ...
        where t1.date1 between '2018-12-31' and '2019-01-27'
        )   t2
    inner join
        (select
            *
...
and date(convert_tz(from_unixtime(t1.sucess_at), '+00:00', '+08:00')) between '2018-12-31' and '2019-01-27'
;
...
where t1.flag = 1
and t1.disable = 0
and date(convert_tz(from_unixtime(t4.sucess_at), '+00:00', '+08:00')) between '2018-12-31' and '2019-01-27'
